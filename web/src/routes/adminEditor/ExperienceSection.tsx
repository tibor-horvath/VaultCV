...
export function ExperienceSection(props: {
  ...
  useEffect(() => {
    ...
    const details = document.getElementById(`experience-details-${lastAddedId}`) as HTMLDetailsElement | null
      ...
      <div className="space-y-4">
        ...
        {experience.map((e, idx) => (
          ...
          <div id={`experience-row-${e._id}`} className="group flex items-start gap-1">
            ...
            <details
              id={`experience-details-${e._id}`}
              open={!isMobile}
              className="min-w-0 flex-1 rounded-field border border-line bg-surface p-4"
            >
            ...
            <div className="mt-2 space-y-2 md:mt-0">
              ...
              <div className="grid grid-cols-[1fr_auto] items-start gap-2">
                <div className="space-y-2 rounded-field border border-line p-3">
                  <div className="flex items-center justify-between gap-2">
                    <div className="inline-flex items-center gap-1 text-xs font-semibold text-ink-muted">
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1 rounded-field border border-line px-2 py-1 text-[11px] font-medium text-ink-muted hover:bg-surface-muted"
                    >
                  ...
                  <div className="space-y-2">
                    {(e.links ?? []).map((link, linkIdx) => (
                      <div key={linkIdx} className="grid grid-cols-1 gap-2 rounded-field border border-line p-2 md:grid-cols-[1fr_1fr_auto]">
                        {(() => {
